	...
	Themes = {
		Darker = {
			["Color Hub 1"]      = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(8, 0, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))
			}),
			["Color Hub 2"]      = Color3.fromRGB(10, 0, 0),
			["Color Stroke"]     = Color3.fromRGB(180, 0, 0),
			["Color Theme"]      = Color3.fromRGB(220, 0, 0),
			["Color Text"]       = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"]  = Color3.fromRGB(200, 150, 150),
			["Color Dark Purple"]= Color3.fromRGB(220, 0, 0),
			["Color Hub 9"]      = Color3.fromRGB(0,   0,   0),
			["Color Dark Greem"] = Color3.fromRGB(180, 80, 80)
		},
		Dark = {
			["Color Hub 1"]      = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(12, 0, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))
			}),
			["Color Hub 2"]      = Color3.fromRGB(14, 0, 0),
			["Color Stroke"]     = Color3.fromRGB(200, 0, 0),
			["Color Theme"]      = Color3.fromRGB(230, 0, 0),
			["Color Text"]       = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"]  = Color3.fromRGB(210, 150, 150),
			["Color Dark Purple"]= Color3.fromRGB(230, 0, 0),
			["Color Hub 9"]      = Color3.fromRGB(0,   0,   0),
			["Color Dark Greem"] = Color3.fromRGB(190, 90, 90)
		},
		Purple = {
			["Color Hub 1"]      = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(16, 0, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))
			}),
			["Color Hub 2"]      = Color3.fromRGB(18, 0, 0),
			["Color Stroke"]     = Color3.fromRGB(210, 0, 0),
			["Color Theme"]      = Color3.fromRGB(240, 0, 0),
			["Color Text"]       = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"]  = Color3.fromRGB(215, 155, 155),
			["Color Dark Purple"]= Color3.fromRGB(240, 0, 0),
			["Color Hub 9"]      = Color3.fromRGB(0,   0,   0),
			["Color Dark Greem"] = Color3.fromRGB(195, 95, 95)
		},
		Neon = {
			["Color Hub 1"]      = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
			...
			["Color Hub 2"]      = Color3.fromRGB(20, 0, 0),
			["Color Stroke"]     = Color3.fromRGB(255, 0, 0),
			["Color Theme"]      = Color3.fromRGB(255, 0, 0),
			["Color Text"]       = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"]  = Color3.fromRGB(220, 160, 160),
			["Color Dark Purple"]= Color3.fromRGB(255, 0, 0),
			["Color Hub 9"]      = Color3.fromRGB(0,   0,   0),
			["Color Dark Greem"] = Color3.fromRGB(200, 100, 100)
		}
	},
	Info       = { Version = "2.0.0" },
...
function lopklib:SetTheme(NewTheme)
	...
	SaveJson("op library V2.json", lopklib.Save)
...
task.spawn(function()
	task.wait(3)
	local angle = 0
	local shimmerColor = Color3.fromRGB(255, 0, 0)
	while true do
		task.wait(0.04)
		angle = (angle + 3) % 360
...
local function BuildParticleSystem(ParticleContainer, MainFrameRef)
	...
	local function Spawn()
		...
		local col  = Theme and Theme["Color Theme"] or Color3.fromRGB(200, 30, 30)
...
function lopklib:MakeWindow(Configs)
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			MinimizeButton.ImageColor3 = Color3.fromRGB(200, 30, 30)
		...
		function Tab:AddToggle(Configs)
			...
			local function SetToggle(Val)
				...
				if Default then
					...
					CreateTween({ToggleHolder, "BackgroundColor3", Color3.fromRGB(80, 10, 10), 0.22})
				else
