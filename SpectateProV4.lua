...
for _, old in ipairs({"SpectatePRO_V3","SpectatePRO_V4"}) do
...
task.spawn(function()
    while lockIcon.Parent do
        TweenService:Create(lockIcon,
            ...
            {Size=UDim2.fromOffset(68,68), Position=UDim2.new(0.5,-34,0,16)}):Play()
        task.wait(1.0)
        TweenService:Create(lockIcon,
            TweenInfo.new(1.0, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
            {Size=UDim2.fromOffset(60,60), Position=UDim2.new(0.5,-30,0,20)}):Play()
        task.wait(1.0)
    end
end)
...
codeTitle.Size                   = UDim2.new(1, -20, 0, 26)
codeTitle.Position               = UDim2.fromOffset(10, 90)
...
codeSubTitle.Position               = UDim2.fromOffset(10, 118)
...
codeSubTitle.TextColor3             = Color3.fromRGB(100, 150, 220)
...
codeBoxBg.Size             = UDim2.new(0.86, 0, 0, 46)
codeBoxBg.AnchorPoint      = Vector2.new(0.5, 0)
codeBoxBg.Position         = UDim2.new(0.5, 0, 0, 152)
codeBoxBg.BackgroundColor3 = Color3.fromRGB(8, 22, 65)
...
keyIconLbl.Size                   = UDim2.fromOffset(28, 28)
...
codeBox.Size                     = UDim2.new(1, -48, 1, -12)
codeBox.Position                 = UDim2.fromOffset(44, 6)
...
codeBox.Focused:Connect(function()
    ...
    TweenService:Create(codeBoxBg, TweenInfo.new(0.2), {BackgroundColor3=Color3.fromRGB(12,35,95)}):Play()
end)
codeBox.FocusLost:Connect(function()
    TweenService:Create(boxStroke, TweenInfo.new(0.2), {Transparency=0.4, Color=C_BLUE1}):Play()
    TweenService:Create(codeBoxBg, TweenInfo.new(0.2), {BackgroundColor3=Color3.fromRGB(8,22,65)}):Play()
end)

-- زر الدخول
local confirmBtn                  = Instance.new("TextButton")
confirmBtn.Size                   = UDim2.new(0.86, 0, 0, 46)
confirmBtn.AnchorPoint            = Vector2.new(0.5, 0)
confirmBtn.Position               = UDim2.new(0.5, 0, 0, 210)
...
confirmGrad.Color = ColorSequence.new{
    ...
    ColorSequenceKeypoint.new(1,   Color3.fromRGB(25, 110, 255))
}
...
codeErrLbl.Position               = UDim2.new(0, 0, 1, -24)
...
task.spawn(function()
    while timerLbl.Parent do
        if spectating and liveStartTime > 0 then
            local e = math.floor(tick() - liveStartTime)
