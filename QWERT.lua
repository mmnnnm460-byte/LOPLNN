...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://102593828026424", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})


local ScreenGui = game:GetService("CoreGui"):FindFirstChild("LOPKCyanLib")
if ScreenGui then
    ...
    if MainFrame then
        ...
        NarBG.ImageTransparency = 0 -- جعل الصورة واضحة 100% بدون شفافية
...
local infoTab = Window:MakeTab({ "حقوق", "info" })

infoTab:AddDiscordInvite({
    Name = "fire",
    Description = "",
    Logo = "rbxassetid://102593828026424",
    Invite = "",
})
...
scriptsTab:AddButton({
    ...
    Callback = function()
        ...
        up.Name = "up"
        up.Parent = Frame
        up.BackgroundColor3 = Color3.fromRGB(50, 50, 50)        -- Cinza médio
        ...
        down.Name = "down"
        down.Parent = Frame
        down.BackgroundColor3 = Color3.fromRGB(50, 50, 50)      -- Cinza médio
        ...
        onof.Name = "onof"
        onof.Parent = Frame
        onof.BackgroundColor3 = Color3.fromRGB(50, 50, 50)      -- Cinza médio
        ...
        TextLabel.BackgroundColor3 = Color3.fromRGB(40, 40, 40) -- Cinza médio escuro
        ...
        plus.Name = "plus"
        plus.Parent = Frame
        plus.BackgroundColor3 = Color3.fromRGB(50, 50, 50)      -- Cinza médio
        ...
        speed.Name = "speed"
        speed.Parent = Frame
        speed.BackgroundColor3 = Color3.fromRGB(50, 50, 50)     -- Cinza médio
        ...
        mine.Name = "mine"
        mine.Parent = Frame
        mine.BackgroundColor3 = Color3.fromRGB(50, 50, 50)      -- Cinza médio
...
MusicTab:AddSection("Enviar Áudio")
