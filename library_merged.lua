...
function lopklib:MakeWindow(Configs)
	...
	local function ShowFirstNotify()
		-- تشغيل الموسيقى بطريقة صحيحة
		local _BgMusic = Instance.new("Sound")
		_BgMusic.SoundId = "rbxassetid://84878105728262"
		_BgMusic.Volume = 0.8
		_BgMusic.Looped = false
		_BgMusic.RollOffMaxDistance = 10000
		-- نحط الصوت في workspace عشان يشتغل للـ LocalPlayer
		pcall(function()
			_BgMusic.Parent = workspace
			_BgMusic:Play()
		end)

		-- اشعار 17 ثانية تنازلي
		CyberNotify("⏳ جاري التحميل...", "انتظر 17 ثانية وسيشتغل السكربت", 17, Color3.fromRGB(255, 255, 255))
