...
local lopklib = {
	Themes = {
		Darker = {
			...
			["Color Dark Purple"]= Color3.fromRGB(200, 30, 30),
			["Color Hub 9"]      = Color3.fromRGB(0,   0,   0),
			["Color Dark Greem"] = Color3.fromRGB(160, 160, 160)
		},
		Dark = {
			["Color Hub 1"]      = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
...
task.spawn(function()
	task.wait(3)
	local angle = 0
	local shimmerColor = Color3.fromRGB(200, 30, 30)
	while true do
		task.wait(0.04)
		angle = (angle + 3) % 360
...
function lopklib:MakeWindow(Configs)
	...
	local function BlueNotify(title, text, duration)
		...
		TitleL.Text = title
		TitleL.TextColor3 = Color3.fromRGB(200, 30, 30)
		TitleL.TextSize = 12
